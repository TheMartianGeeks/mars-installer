...
namespace Mars\Installer\Console;
...
class NewCommand extends Command
{
    ...
    protected function configure()
    {
        $this
            ->setName('new')
            ->setDescription('Create a new Marsphp application.')
    ...
    {
        return getcwd().'/marsphp_'.md5(time().uniqid()).'.zip';
    }
    ...
    protected function download($zipFile, $version = 'master')
    {
        ...
        $response = (new Client)->get('https://github.com/marsphp/mars/archive/'.$filename);
